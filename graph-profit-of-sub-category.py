...
load_data = pd.read_csv("sub-category-for-profit.csv", header=0, sep=",")

# get values of 'sum_profit' to draw graph on x-axis
profit = load_data['sum_profit']
...
ax.set_title('Profit for Sub_Category')
ax.set_xlabel('Profit')
ax.set_ylabel('Sub_Category')
ax.set_yticklabels(y_labels) # create tick for labels of y-axis
ax.set_xlim(-30000, 70000) # set x-axis cho rong hon - de nhin
...
plt.savefig("tong_profit-for-sub-category.png")
#plt.show()